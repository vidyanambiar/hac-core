...
const webpackProxy = {
  ...
  customProxy: [
    ...
    },
    {
      ...
      target: 'https://console.dev.redhat.com:443/api/kcp',
      secure: false,
      changeOrigin: true,
      autoRewrite: true,
      ws: true,
      pathRewrite: { '^/api/k8s': '/clusters/root:users:qs:ie:rh-sso-vnambiar-hac' },
    ...
    pluginProxy('hac-infra'),
    {
      ...
      autoRewrite: true,
      ws: true,
      pathRewrite: { '^/wss/k8s': '/clusters/root:users:qs:ie:rh-sso-vnambiar-hac' },
      withCredentials: true,
    },
  ],
};
